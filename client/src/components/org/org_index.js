...
const projectId = '2G7PwMIOztLtoIwbyRxS0HdBOdr';
const projectSecret = 'a9049a09857cd9bba9430c0fde7843cf';
const auth =
...
class Org extends Component {
  ...
  captureFile = (event) => {
    ...
    fr.onload = function (e) {
      ...
      switch (name) {
        case "p_photo":
          this.setState({ p_photo_url: textread });
          break
        case "citizenship_front":
          this.setState({ citizenship_front_url: textread });
          break
        case "citizenship_back":
          this.setState({ citizenship_back_url: textread });
          break
    ...
    if (file) {
      ...
      switch (name) {
        case "p_photo":
          this.setState({ p_photo_url: "" });
          break
        case "citizenship_front":
          this.setState({ citizenship_front_url: "" });
          break
        case "citizenship_back":
          this.setState({ citizenship_back_url: "" });
          break
  ...
  render() {
    ...
    if (this.state.loadingorg) {
      ...
      content = validOrg ? (
          ...
          <Switch>
            ...
            <Route exact path="/Organization/add">
              <Addkyc
                ...
                citizenship_back={this.state.citizenship_back_url}
                citizenship_front={this.state.citizenship_front_url}
                p_photo={this.state.p_photo_url}
              />
            </Route>
        ...
        <Unauthorized>Your account is not a registered organization, Try switching your account from Metamask (Your Web3 provider).</Unauthorized>
      );
    }
