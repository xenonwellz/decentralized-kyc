    ...
    return (
        <Container>
            <div className="p-5 mt-4 bg-gray-100 rounded-xl">
                <Form style={{ width: "80%", margin: "auto" }} onSubmit={props.updateKyc}>
                    <h2 className="mb-4 text-2xl text-gray-700">Update KYC </h2>
                    ...
                    <div className="flex items-start gap-4">
                        <label htmlFor="p_photo" className="w-1/3 text-center bg-white file rounded-xl">
                            <div className="p-3 font-semibold text-center rounded-full" type="button">
                    ...
                    <br />
                    <button className="px-6 py-2 font-semibold text-white rounded-full bg-sky-700" type="submit">Update</button>
                    <div className="mt-4">
                        {props.loading ? <p style={{ color: 'blue' }}>Updating Customer KYC...</p> :
                            props.error ? <p style={{ color: "red" }}>{props.errormsg}</p> : props.added && <p style={{ color: "green" }}>Customer KYC Updated</p>}
                    </div>
                </Form>
            </div>
        </Container>
