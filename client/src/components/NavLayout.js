...
const NavLayout = ({ children, account }) => {
    return (
        <div className="shadow-sm border-b">
            <div className="flex h-16 justify-between container items-center">
                <a href='/' className='text-sky-900 hover:text-gray-900 no-underline'>
                    <svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 inline-block" fill='currentColor'>
                        <path
            ...
            {account ? <div className="border-t py-2 w-full">
                <div className="container"><span className="rounded-full h-3 mr-2 w-3 inline-block bg-green-600"></span><b>Connected: </b> {account}</div>
            </div> : ""}
        </div>
    );
}
