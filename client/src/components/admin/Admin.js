  ...
  render() {
    ...
    if (this.state.loadingadmin) {
      ...
      content = validAdmin ? (
        ...
        <Unauthorized>Your account is not the Administrator, Try switching your account to the account that deployed the smart contract (Ganache account[0]) from Metamask (Your Web3 provider).</Unauthorized>
      );
    }
